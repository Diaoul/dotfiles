return {
  ...
  -- search and replace in multiple files
  {
    ...
    opts = {
      headerMaxWidth = 80,
      keymaps = {
        openNextLocation = { n = false },
        openPrevLocation = { n = false },
      },
    },
    cmd = "GrugFar",
    keys = {
  ...
  -- git signs
  {
    ...
    opts = {
      ...
      on_attach = function(buffer)
        ...
        map("n", "<leader>ghq", gs.toggle_deleted, "Toggle Deleted")
        -- text objects
  ...
  -- increment and decrement
  {
    ...
    -- stylua: ignore
    keys = {
      { "<C-a>", function() return require("diaoul.util.dial").dial(true) end, expr = true, desc = "Increment", mode = {"n", "v"} },
      { "<C-x>", function() return require("diaoul.util.dial").dial(false) end, expr = true, desc = "Decrement", mode = {"n", "v"} },
      { "g<C-a>", function() return require("diaoul.util.dial").dial(true, true) end, expr = true, desc = "Increment", mode = {"n", "v"} },
      { "g<C-x>", function() return require("diaoul.util.dial").dial(false, true) end, expr = true, desc = "Decrement", mode = {"n", "v"} },
    },
    opts = function()
