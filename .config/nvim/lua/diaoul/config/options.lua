...
opt.sessionoptions = { "buffers", "curdir", "tabpages", "winsize", "help", "globals", "skiprtp", "folds" } -- Session persistence
...
opt.winborder = "rounded" -- Default border style for all floating windows
opt.wrap = false -- Line wrap
opt.breakindent = true -- Ident broken lines
opt.linebreak = false -- Break long lines smartly
