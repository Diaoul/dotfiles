#!/usr/bin/env bash
# run `pactl list short sinks` to get sink names
pulseaudio-control \
    ...
    --node-nickname "bluez_output.14_3F_A6_10_80_39.1: %{F#a89984}%{F-} WH-1000XM4" \
    --node-nickname "bluez_output.88_C9_E8_1D_2E_33.1: %{F#a89984}%{F-} WF-1000XM4" \
